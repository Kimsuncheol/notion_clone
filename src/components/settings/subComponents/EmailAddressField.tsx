  ...
  return (
    <div className='flex flex-col gap-4 w-full pb-4 border-b-[1px] border-gray-200'>
      <div className='flex w-full items-center gap-4'>
        ...
        <div className='text-[16px] font-semibold h-full' style={{ color: generalTextColor }}>{user?.email || 'Anonymous'}</div>
      </div>
      <div className='' style={{ color: generalTextColor, fontSize: fontSize }}>This is email address that you use to login to your account</div>
    </div>
  )
}
