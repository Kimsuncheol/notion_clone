...
export default function MoreoptionsModal({ noteId, setShowMoreOptions }: { noteId: string, setShowMoreOptions: (show: boolean) => void }) {
  ...
  return (
    <div className="absolute top-full right-0 mt-1 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg py-2 min-w-48 z-50" style={{ backgroundColor: grayColor2 }}>
      <button
        onClick={onCopyLink}
